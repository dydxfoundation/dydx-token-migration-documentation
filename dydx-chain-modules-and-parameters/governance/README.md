...
A proposal can be expedited, which shortens the voting duration to 2 days and sets a higher tally threshold by default. If the expedited proposal does not meet the threshold within the shortened voting period, it is converted to a regular proposal and the voting restarts under standard conditions.
